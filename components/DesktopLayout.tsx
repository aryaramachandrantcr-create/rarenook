...
import {
  ...
  IconCart, IconHandshake, IconPackage, IconChat,
} from "./shared";
...
function DesktopNav({ screen, onNavigate, onNotif, onProfile }: {
  ...
  return (
    <nav style={{
      ...
      <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 clamp(24px, 4vw, 64px)", display: "flex", alignItems: "center", height: "64px", gap: "32px" }}>
        {/* Logo */}
        <div
        ...
        >
          <LogoBall />
          <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "19px", fontWeight: 900, color: T.navy }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  fontFamily: "'Space Grotesk', sans-serif", fontSize: "13px", fontWeight: isActive ? 800 : 600,
        ...
        <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
          ...
          <div
            onClick={onProfile}
            style={{ width: "36px", height: "36px", borderRadius: "50%", background: T.yellow, border: `2px solid ${T.navy}`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Space Grotesk', sans-serif", fontWeight: 900, fontSize: "14px", color: T.navy, cursor: "pointer" }}
          >A</div>
        </div>
      </div>
    </nav>
...
function DesktopHome({ onNavigate, onListing, onInfoPage }: {
  ...
  return (
    <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "40px clamp(24px, 4vw, 64px)" }}>

      {/* Hero */}
      <div style={{ background: "linear-gradient(135deg, #FFD740 0%, #FFE878 60%, #FFF5C0 100%)", borderRadius: "24px", padding: "clamp(36px, 5vw, 64px) clamp(36px, 5vw, 72px)", marginBottom: "40px", position: "relative", overflow: "hidden", boxShadow: T.s2 }}>
        ...
        <div style={{ maxWidth: "560px", position: "relative" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
            <div style={{ display: "inline-block", background: T.navy, color: T.yellow, fontFamily: "'Space Grotesk', sans-serif", fontSize: "11px", fontWeight: 800, padding: "4px 12px", borderRadius: "50px" }}>
              🇮🇳 India's First Collector Marketplace
            </div>
            <div onClick={() => onInfoPage("about")} style={{ fontSize: "11px", fontWeight: 700, color: T.navy, opacity: 0.55, cursor: "pointer", textDecoration: "underline", fontFamily: "'Space Grotesk', sans-serif" }}>About RareNook</div>
          </div>
          <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "38px", fontWeight: 900, color: T.navy, lineHeight: 1.15, marginBottom: "14px" }}>
          ...
          <div style={{ display: "flex", gap: "12px" }}>
            <div onClick={() => onNavigate("Marketplace")} style={{ padding: "13px 28px", background: T.navy, borderRadius: "14px", fontFamily: "'Space Grotesk', sans-serif", fontSize: "14px", fontWeight: 900, color: T.yellow, cursor: "pointer", boxShadow: "3px 4px 0 rgba(28,35,64,0.2)", transition: "transform 0.15s" }} onMouseEnter={e => (e.currentTarget as HTMLElement).style.transform = "translateY(-2px)"} onMouseLeave={e => (e.currentTarget as HTMLElement).style.transform = "translateY(0)"}>Browse Cards</div>
            <div onClick={() => onListing("sell")} style={{ padding: "13px 28px", background: "rgba(255,255,255,0.6)", borderRadius: "14px", fontFamily: "'Space Grotesk', sans-serif", fontSize: "14px", fontWeight: 700, color: T.navy, cursor: "pointer", border: "1.5px solid rgba(28,35,64,0.18)", transition: "background 0.15s" }} onMouseEnter={e => (e.currentTarget as HTMLElement).style.background = "rgba(255,255,255,0.85)"} onMouseLeave={e => (e.currentTarget as HTMLElement).style.background = "rgba(255,255,255,0.6)"}>Sell a Card</div>
            <div onClick={() => onNavigate("TradeHub")} style={{ padding: "13px 28px", background: "transparent", borderRadius: "14px", fontFamily: "'Space Grotesk', sans-serif", fontSize: "14px", fontWeight: 700, color: T.navy, cursor: "pointer", border: "1.5px solid rgba(28,35,64,0.25)", transition: "background 0.15s" }} onMouseEnter={e => (e.currentTarget as HTMLElement).style.background = "rgba(255,255,255,0.4)"} onMouseLeave={e => (e.currentTarget as HTMLElement).style.background = "transparent"}>Start Trading</div>
          </div>
        </div>
        ...
        <div style={{ position: "absolute", right: "56px", top: "50%", transform: "translateY(-50%)", display: "flex", flexDirection: "column" as const, gap: "16px" }}>
          {[
            ...
            <div key={s.lbl} style={{ textAlign: "center" as const, background: "rgba(255,255,255,0.55)", borderRadius: "14px", padding: "12px 20px", backdropFilter: "blur(4px)" }}>
              <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "22px", fontWeight: 900, color: T.navy }}>{s.val}</div>
      ...
      {/* Platform features */}
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: "16px", marginBottom: "52px" }}>
        {[
          ...
          <div key={f.label} onClick={() => f.screen ? onNavigate(f.screen) : onInfoPage("about")} style={{ background: T.white, borderRadius: "18px", padding: "20px 18px", boxShadow: T.s1, border: `1.5px solid ${T.border}`, cursor: "pointer", transition: "transform 0.15s, box-shadow 0.15s" }} onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = "translateY(-3px)"; (e.currentTarget as HTMLElement).style.boxShadow = T.s2; }} onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLElement).style.boxShadow = T.s1; }}>
            ...
            <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "14px", fontWeight: 900, color: T.ink, marginBottom: "5px" }}>{f.label}</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "32px", marginBottom: "48px" }}>
        ...
        <div>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
            <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "18px", fontWeight: 900, color: T.ink }}>Trending Now 🔥</div>
            ...
            {trending.map(card => (
              <div key={card.id} onClick={() => onNavigate("CardDetail")} style={{ background: T.white, borderRadius: "18px", boxShadow: T.s1, overflow: "hidden", border: `1.5px solid ${T.border}`, cursor: "pointer", transition: "transform 0.15s, box-shadow 0.15s" }} onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = "translateY(-2px)"; (e.currentTarget as HTMLElement).style.boxShadow = T.s2; }} onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLElement).style.boxShadow = T.s1; }}>
                ...
                <div style={{ padding: "10px 11px 12px" }}>
                  <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "12px", fontWeight: 900, color: T.ink }}>{card.name}</div>
                  <div style={{ fontSize: "10px", color: T.inkSoft, marginTop: "2px", marginBottom: "5px" }}>{card.set} · {card.lang}</div>
                  <div style={{ display: "inline-block", fontFamily: "'Space Grotesk', sans-serif", fontSize: "10px", fontWeight: 800, padding: "2px 8px", borderRadius: "50px", border: "1px solid rgba(0,0,0,0.08)", ...condStyle[card.condType], marginBottom: "5px" }}>{card.cond}</div>
        ...
        <div style={{ display: "flex", flexDirection: "column" as const, gap: "24px" }}>
          {/* Market Movers */}
          <div>
            <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "18px", fontWeight: 900, color: T.ink, marginBottom: "14px" }}>Market Movers 📈</div>
            <div style={{ background: T.white, borderRadius: "18px", boxShadow: T.s1, overflow: "hidden", border: `1.5px solid ${T.border}` }}>
              {MOVERS.map((m, i) => (
                <div key={m.id} style={{ display: "flex", alignItems: "center", gap: "14px", padding: "13px 16px", borderTop: i > 0 ? `1px solid rgba(28,35,64,0.06)` : "none", cursor: "pointer", transition: "background 0.15s" }} onMouseEnter={e => (e.currentTarget as HTMLElement).style.background = T.skySoft} onMouseLeave={e => (e.currentTarget as HTMLElement).style.background = "transparent"}>
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "13px", fontWeight: 800, color: T.ink }}>{m.name}</div>
                    <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "14px", fontWeight: 900, color: T.ink, marginTop: "2px" }}>{m.price}</div>
                  </div>
          ...
          {/* Verified Sales */}
          <div>
            <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "18px", fontWeight: 900, color: T.ink, marginBottom: "14px" }}>Verified Sales ✅</div>
            <div style={{ background: T.white, borderRadius: "18px", boxShadow: T.s1, overflow: "hidden", border: `1.5px solid ${T.border}` }}>
              {SALES.map((s, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: "12px", padding: "12px 16px", borderTop: i > 0 ? `1px solid rgba(28,35,64,0.06)` : "none" }}>
                  ...
                  <div style={{ textAlign: "right" as const }}>
                    <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "14px", fontWeight: 900, color: T.ink }}>{s.price}</div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
        <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "18px", fontWeight: 900, color: T.ink }}>All Listings</div>
        ...
        {ALL_CARDS.filter(c => c.category === "cards").map(card => (
          <div key={card.id} onClick={() => onNavigate("CardDetail")} style={{ background: T.white, borderRadius: "18px", boxShadow: T.s1, overflow: "hidden", border: `1.5px solid ${T.border}`, cursor: "pointer", transition: "transform 0.15s, box-shadow 0.15s" }} onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = "translateY(-2px)"; (e.currentTarget as HTMLElement).style.boxShadow = T.s2; }} onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLElement).style.boxShadow = T.s1; }}>
            <div style={{ height: "120px", background: card.bg, display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
              <span style={{ position: "absolute", top: "8px", left: "10px", fontSize: "9px", fontWeight: 700, color: "rgba(28,35,64,0.3)", fontFamily: "'Space Grotesk', sans-serif" }}>{card.no}</span>
              <CardArt artKey={card.art as ArtKey} size={62} />
            </div>
            <div style={{ padding: "11px 12px 13px" }}>
              <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "13px", fontWeight: 900, color: T.ink, lineHeight: 1.2 }}>{card.name}</div>
              <div style={{ fontSize: "10px", color: T.inkSoft, marginTop: "2px", marginBottom: "6px" }}>{card.set} · {card.lang} · {card.year}</div>
              <div style={{ display: "inline-block", fontFamily: "'Space Grotesk', sans-serif", fontSize: "10px", fontWeight: 800, padding: "2px 9px", borderRadius: "50px", border: "1px solid rgba(0,0,0,0.08)", ...condStyle[card.condType], marginBottom: "6px" }}>{card.cond}</div>
              <div style={{ fontSize: "9px", color: T.inkSoft, fontWeight: 600, textTransform: "uppercase" as const, letterSpacing: "0.04em" }}>Market Value</div>
              <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "16px", fontWeight: 900, color: T.ink }}>{card.price}</div>
            </div>
          </div>
        ))}
      </div>
      ...
      <div style={{ borderTop: `1px solid ${T.border}`, paddingTop: "24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <LogoBall />
          <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "15px", fontWeight: 900, color: T.navy }}>Rare<span style={{ color: T.coral }}>Nook</span></span>
        ...
        <div style={{ display: "flex", gap: "6px" }}>
          {(["about","help","contact"] as const).map(p => (
            <div key={p} onClick={() => onInfoPage(p)} style={{ padding: "6px 14px", background: T.white, borderRadius: "50px", border: `1.5px solid ${T.border}`, fontFamily: "'Space Grotesk', sans-serif", fontSize: "11px", fontWeight: 700, color: T.inkMid, cursor: "pointer" }}>
  ...
  return (
    <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "40px clamp(24px, 4vw, 64px)" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
        <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "28px", fontWeight: 900, color: T.ink }}>Marketplace</div>
        <div style={{ display: "flex", alignItems: "center", gap: "8px", background: T.white, border: `1.5px solid ${T.border}`, borderRadius: "14px", padding: "8px 14px", boxShadow: T.s1 }}>
          ...
          <input placeholder="Search cards, sets, sellers..." style={{ border: "none", outline: "none", fontFamily: "'Inter', sans-serif", fontSize: "14px", color: T.inkMid, background: "transparent", width: "260px" }} />
        </div>
      </div>
      ...
      <div style={{ display: "flex", gap: "8px", marginBottom: "28px" }}>
        {cats.map(cat => {
          ...
          return (
            <div key={cat} onClick={() => handleCat(cat)} style={{ padding: "7px 18px", borderRadius: "50px", fontFamily: "'Space Grotesk', sans-serif", fontSize: "13px", fontWeight: 700, cursor: "pointer", background: isOn ? T.navy : T.white, color: isOn ? T.yellow : T.inkMid, border: `1.5px solid ${isOn ? T.navy : T.border}`, transition: "all 0.15s" }}>{cat}</div>
          );
        })}
        <div style={{ marginLeft: "auto", padding: "7px 18px", borderRadius: "50px", fontFamily: "'Space Grotesk', sans-serif", fontSize: "13px", fontWeight: 700, color: T.lavender, cursor: "pointer", border: `1.5px solid ${T.border}`, background: T.white }}>
        ...
        {cards.map(card => (
          <div key={card.id} onClick={() => onNavigate("CardDetail")} style={{ background: T.white, borderRadius: "20px", boxShadow: T.s1, overflow: "hidden", border: `1.5px solid ${T.border}`, cursor: "pointer", transition: "transform 0.15s, box-shadow 0.15s" }} onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = "translateY(-3px)"; (e.currentTarget as HTMLElement).style.boxShadow = T.s2; }} onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLElement).style.boxShadow = T.s1; }}>
            ...
            <div style={{ padding: "12px 14px 14px" }}>
              <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "13px", fontWeight: 900, color: T.ink }}>{card.name}</div>
              <div style={{ fontSize: "11px", color: T.inkSoft, marginTop: "2px", marginBottom: "7px" }}>{card.set} · {card.lang} · {card.year}</div>
              <div style={{ display: "inline-block", fontFamily: "'Space Grotesk', sans-serif", fontSize: "10px", fontWeight: 800, padding: "3px 10px", borderRadius: "50px", border: "1px solid rgba(0,0,0,0.08)", ...condStyle[card.condType], marginBottom: "7px" }}>{card.cond}</div>
              <div style={{ fontSize: "9px", color: T.inkSoft, fontWeight: 600, textTransform: "uppercase" as const, letterSpacing: "0.04em" }}>Market Value</div>
              <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "17px", fontWeight: 900, color: T.ink }}>{card.price}</div>
              <div style={{ marginTop: "10px", padding: "9px 0", background: T.navy, borderRadius: "10px", fontFamily: "'Space Grotesk', sans-serif", fontSize: "12px", fontWeight: 800, color: T.yellow, textAlign: "center" as const, cursor: "pointer" }}>View Listing</div>
            </div>
          </div>
        ))}
      </div>
...
function DesktopComingSoon({ title, icon, message, onHome }: {
  ...
  return (
    <div style={{ maxWidth: "600px", margin: "80px auto", padding: "0 32px", textAlign: "center" as const }}>
      ...
      <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "28px", fontWeight: 900, color: T.ink, marginBottom: "12px" }}>{title}</div>
      <div style={{ fontSize: "15px", color: T.inkSoft, lineHeight: 1.7, marginBottom: "32px" }}>{message}</div>
      <div onClick={onHome} style={{ display: "inline-block", padding: "13px 32px", background: T.navy, borderRadius: "14px", fontFamily: "'Space Grotesk', sans-serif", fontSize: "14px", fontWeight: 900, color: T.yellow, cursor: "pointer" }}>← Back to Home</div>
    </div>
  );
}
