  ...
  return (
    <div style={{ margin: "0 16px 12px", background: T.white, borderRadius: "22px", boxShadow: T.s1, border: `1.5px solid ${T.border}`, overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "9px", padding: "12px 13px 9px" }}>
        <div style={{ width: "32px", height: "32px", borderRadius: "50%", background: post.avatarBg, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Nunito, sans-serif", fontSize: "13px", fontWeight: 900, color: T.ink, flexShrink: 0, border: `1.5px solid ${T.border}` }}>{post.letter}</div>
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: "Nunito, sans-serif", fontSize: "12px", fontWeight: 700, color: T.ink }}>{post.user}</div>
          <div style={{ fontSize: "10px", color: T.inkSoft }}>{post.city} · {post.time}</div>
        </div>
        <div style={{ fontFamily: "Nunito, sans-serif", fontSize: "9px", fontWeight: 800, padding: "3px 9px", borderRadius: "50px", background: post.tagBg, color: post.tagColor, border: `1.5px solid rgba(0,0,0,0.08)` }}>{post.tag}</div>
      </div>

      {/* Body */}
      <div style={{ padding: "0 13px 10px" }}>
        <div style={{ fontFamily: "Nunito, sans-serif", fontSize: "13px", fontWeight: 900, color: T.ink, marginBottom: "5px" }}>{post.title}</div>
      ...
      <div style={{ display: "flex", gap: "0", padding: "9px 13px", borderTop: `1px solid rgba(28,35,64,0.06)` }}>
        ...
        >
          ...
          <span style={{ fontFamily: "Nunito, sans-serif", fontSize: "11px", fontWeight: 700, color: post.liked ? T.coral : T.inkSoft }}>{post.likes}</span>
        </div>
        <div
          onClick={onComment}
        ...
        >
          ...
          <span style={{ fontFamily: "Nunito, sans-serif", fontSize: "11px", fontWeight: 700, color: T.inkSoft }}>{post.comments}</span>
        </div>
        <div style={{ flex: 1, display: "flex", alignItems: "center", gap: "5px", cursor: "pointer" }}>
          ...
          <span style={{ fontFamily: "Nunito, sans-serif", fontSize: "11px", fontWeight: 700, color: T.inkSoft }}>Share</span>
        </div>
      </div>
    </div>
  );
    ...
    <>
      ...
      <PhoneShell>
        ...
        <div style={{ background: T.sky, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "4px 18px 12px" }}>
          <div style={{ fontFamily: "Nunito, sans-serif", fontSize: "19px", fontWeight: 900, color: T.navy }}>Community</div>
          <div
        ...
        <div style={{ maxHeight: "636px", overflowY: "auto", overflowX: "hidden" }}>
          ...
          <div style={{ padding: "4px 16px 10px" }}>
            <div style={{ fontFamily: "Nunito, sans-serif", fontSize: "15px", fontWeight: 900, color: T.ink, marginBottom: "10px" }}>🏷 Trending Tags</div>
            <div style={{ display: "flex", flexWrap: "wrap" as const, gap: "7px" }}>
              {TAGS.map((tag, i) => (
                <div
                  ...
                  style={{ padding: "6px 14px", borderRadius: "50px", fontFamily: "Nunito, sans-serif", fontSize: "12px", fontWeight: 700, cursor: "pointer", background: TAG_STYLES[i].bg, color: TAG_STYLES[i].color, border: `1.5px solid rgba(0,0,0,0.08)`, transition: "transform 0.15s" }}
